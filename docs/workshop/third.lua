...
function aerospike_proto.dissector(tvbuf, pktinfo, root)
   ...
   local header_type_tvbr = tvbuf:range(PROTO_TYPE_START, PROTO_TYPE_LENGTH)
   ...
   tree:add(header_fields.type, header_type_tvbr)   
   tree:add(header_fields.size, size_tvbr)
